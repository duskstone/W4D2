# PHASE 2
# Update convert_to_int to rescue any errors and return nil if our argument cannot be converted.
...
def convert_to_int(str)
    ...
    Integer(str)
        ...
        #NameError aka local variable error w/non-str word
        nil
    end
end
...
class CoffeeError < StandardError
  def message
    "Sorry more coffee is no bueno."
  end 
end 

class NotAFruitError < StandardError
  def message
    "Thats not a fruit :( *waddles away sadly*"
  end 
end 
